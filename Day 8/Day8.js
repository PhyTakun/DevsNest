function create(){
    ...
    for(let i = 0; i < 400; i++){        
        ...
        {
            newPixel.className = "btn-white";
        }
        else{
            newPixel.className = "btn-red";
        }
    }    
}

function clicked(selected){
    if(selected.target.className == "btn-red"){
        selected.target.className = "btn-white";
    }
    else{
        selected.target.className = "btn-red"
    }
}
